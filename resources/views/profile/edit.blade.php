                ...
                <div class="card nocanvas mb-4" >
                    ...
                    <div class="card-body">
                        <p class="card-text">
                            ...
                            <br>
                            {{ $profile->user->email }} <a href="{{ route('user.edit', ['id'=>$profile->user->id]) }}">O'zgartirish</a>
                            <br>
                            Mashinasi: <a href="{{ route('car.edit', ['id'=>$profile->car_id]) }}">{{ \App\Car::find($profile->car_id)->car_number }}</a>
                        </p>
                    </div>
                </div>
